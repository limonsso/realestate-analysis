#!/usr/bin/env python3
"""
🚀 Lanceur du Test d'Extraction Saint-Hyacinthe Plex

Script simplifié pour lancer le test d'extraction de plex à Saint-Hyacinthe.
"""
...
from tests.test_saint_hyacinthe_plex_extraction import SaintHyacinthePlexExtractionTest
import structlog
...
async def main():
    ...
    logger.info("🚀 Lancement du Test d'Extraction Saint-Hyacinthe Plex")
    logger.info("=" * 60)
    
    try:
        # Créer et exécuter le test
        test = SaintHyacinthePlexExtractionTest()
        ...
        if results["success"]:
            ...
            print("\n" + "="*60)
            print("🎉 RÉSULTATS DU TEST SAINT-HYACINTHE PLEX")
            print("="*60)
...
if __name__ == "__main__":
    print("🏠 Test d'Extraction Réelle: Plex à Saint-Hyacinthe")
    print("=" * 60)
    print("Ce test va:")
    print("1. 🔍 Rechercher des plex à Saint-Hyacinthe sur Centris.ca")
